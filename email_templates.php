  ...
  <body>
    ...
    <div id="topHeaderBar" class="w3-top w3-cell-row w3-area-blue">
      <div class="w3-container w3-padding-16">
        <div class="contact_info">Create Email</div>
      </div>
      <div onclick="openGoogleSlides(CONFIG['tips on prewritten messages page']['Email'])" class="w3-container w3-cell w3-xlarge w3-right-align">
    ...
    <div class="w3-container w3-white w3-padding w3-card-subtle">
        <a id="startBlankBtn" onclick="logAttemptBeforeSendingToLink(this,2)" href="#" target="_parent" class="w3-button w3-email-color w3-large w3-round" style="margin-right: 10px;">Start a Blank Email</a>OR
    </div>
...
setTimeout(async ()=> {
  ...
  await fillMessageExamples('email', messageExamples);
}, 10);
